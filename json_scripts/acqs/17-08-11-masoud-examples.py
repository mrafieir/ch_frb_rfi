...
rf_pipelines.json_write('../../json_files/acqs/17-08-11-masoud-example1.json', 
...
rf_pipelines.json_write('../../json_files/acqs/17-08-11-masoud-example2.json',
...
rf_pipelines.json_write('../../json_files/acqs/17-08-11-masoud-example3.json',
...
rf_pipelines.json_write('../../json_files/acqs/17-08-11-masoud-example4.json',
...
rf_pipelines.json_write('../../json_files/acqs/17-08-11-masoud-example5.json',
...
rf_pipelines.json_write('../../json_files/acqs/17-08-11-masoud-example6.json',
...
rf_pipelines.json_write('../../json_files/acqs/17-08-11-masoud-example7.json',
                        ch_frb_rfi.acquisitions.incoherent_pathfinder(search_name='frb_incoherent_2d', sample_index=2),
                        clobber = clobber)

# Masoud says: "Another highly active RF environment."
rf_pipelines.json_write('../../json_files/acqs/17-08-11-masoud-example8.json',
...
rf_pipelines.json_write('../../json_files/acqs/17-08-11-masoud-example9.json',
...
rf_pipelines.json_write('../../json_files/acqs/17-08-11-masoud-example10.json',
                        ch_frb_rfi.acquisitions.incoherent_pathfinder(search_name='frb_incoherent_2b', sample_index=2),
                        clobber = clobber)

# Masoud says: "6 hours of data"
rf_pipelines.json_write('../../json_files/acqs/17-08-11-masoud-example11.json',
                        ch_frb_rfi.acquisitions.incoherent_pathfinder(search_name='frb_incoherent_search_2'),
                        clobber = clobber)

# Masoud says: "5 min of data"
rf_pipelines.json_write('../../json_files/acqs/17-08-11-masoud-example12.json',
                        ch_frb_rfi.acquisitions.incoherent_pathfinder(search_name='frb_incoherent_search_3', sample_index=6),
                        clobber = clobber)

# Masoud says: "4 min of data"
rf_pipelines.json_write('../../json_files/acqs/17-08-11-masoud-example13.json',
