...
# of acquisitions obtained in February 2021).
...
# in February 2021.  See 'json_files/acqs/21-03-02-alice-rfi-storms-runlist.json'
...
for make_plots in [ False, True ]:
    ...
    filename = '../../json_files/rfi_16k/21-03-07-low-latency-uniform-badchannel-mask%s.json' % suffix
