...
filename_list.sort()
s = rf_pipelines.chime_frb_stream_from_filename_list(filename_list[450:550], nt_chunk=1024, noise_source_align= 0)
...
t = ch_frb_rfi.transform_chain(p)
t += [ ch_frb_rfi.bonsai.make_dedisperser(p, '/home/l1operator/ch_frb_l1/bonsai_configs/bonsai_production_noups_nbeta1_v2_nbits32.hdf5') ]
#t += [ ch_frb_rfi.bonsai.make_dedisperser(p, '/data/bonsai_configs/bonsai_production_noups_nbeta1_v2.hdf5') ]
