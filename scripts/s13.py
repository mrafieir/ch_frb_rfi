...
s = ch_frb_rfi.acquisitions.incoherent_pathfinder(search_name='frb_incoherent_3d', sample_index=5)
...
p = ch_frb_rfi.transform_parameters(plot_type = 'web_viewer',
                                    ...
                                    L1Grouper_thr = 10,
                                    bonsai_event_outfile = './events_s13.dat')

t = ch_frb_rfi.transform_chain(p)

ch_frb_rfi.run_in_scratch_dir('s13', s, t)
...
ch_frb_rfi.run_for_web_viewer('s13', s, t)
