...
s = ch_frb_rfi.acquisitions.incoherent_pathfinder(search_name='frb_incoherent_2d', sample_index=1)
...
p = ch_frb_rfi.transform_parameters(plot_type = 'web_viewer',
                                    ...
                                    L1Grouper_thr = 10,
                                    bonsai_event_outfile = './events_s8.dat')

t = ch_frb_rfi.transform_chain(p)

ch_frb_rfi.run_in_scratch_dir('s8', s, t)
...
ch_frb_rfi.run_for_web_viewer('s8', s, t)
